...
base_url = "https://www.tennis.co.kr/tkboard/tkboard_list.php?category=global"
driver.get(base_url)
...
# 엑셀 파일로 저장
df.to_excel('테니스코리아_해외_요약.xlsx', index=False)

print("기사 내용 및 요약이 '테니스코리아_해외_요약.xlsx' 파일에 저장되었습니다.")
